...
|----|--------|-----|-------|------|-----------|
|1 초|	128 MB|	4530|	2961|	2626|	66.230%|
...
- [백준 대지 문제](https://www.acmicpc.net/problem/9063)

### 문제 풀이 방식

우선 직사각형의 넓이는 각 좌표들의 최댓값에서 최솟값을 빼서 두 좌표를 곱하면 직사각형의 넓이다 된다. 그런데 좌표들은 자연수만 있는 것이 아닌 마이너스도 존재하기에 이전들과 달리 시작시에 최댓값 좌표들을 -2134567890 으로 설정하여 시작하여야한다.
